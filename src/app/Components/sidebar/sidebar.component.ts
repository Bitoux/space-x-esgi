...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/rockets', title: 'Rockets',  icon: 'notifications', class: '' },
    { path: '/capsules', title: 'Capsules',  icon: 'unarchive', class: '' },
    { path: '/launchpads', title: 'Launchpads',  icon: 'unarchive', class: '' },
